...
- https://github.com/neo4j-contrib/neodash[clone this repository.]
...
YAML examples are available in the https://github.com/neo4j-contrib/neodash[NeoDash repository]. Here is an example of a pod definition YAML file to create a NeoDash pod in a cluster:
...
A Kubernetes Helm chart is available in the https://github.com/neo4j-contrib/neodash[the NeoDash repository] and here is the full example of the Helm chart values.yaml file,
